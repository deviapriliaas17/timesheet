                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control small" id="createProject"
                                                name="project">
                                                @foreach ($projects as $key => $value)
                                                <option value="{{ $value }}"
                                                {{ $key == $id_projects ? 'selected' : '' }}>
                                                {{ $value }}
                                            </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control small" id="createProjectLocation"
                                                    name="project_location">
                                                    @foreach ($project_locations as $value)
                                                    <option value="{{ $value->project_location_code }}">
                                                            {{ $value->location_name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
